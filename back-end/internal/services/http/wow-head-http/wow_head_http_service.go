...
func (s *WowHeadHttpService) GetMountIcon(id int) *httpresponses.WowHeadTooltip {
	client := &http.Client{
...
func (s *WowHeadHttpService) GetWowHeadTooltip(tooltipType string, id string) *httpresponses.WowHeadTooltip {
	...
	var result httpresponses.WowHeadTooltip
...
func (s *WowHeadHttpService) getTooltipFromLocation(locationHeader string) (*httpresponses.WowHeadTooltip, error) {
