...
func GetMountsAggregation(character battlenetEntities.BattleNetCharacter, collection battlenetEntities.BattleNetCharacterMountCollection, view documents.MountViewDocument) []response.MountCollectionCategory {
...
func getCollectedIds(collection battlenetEntities.BattleNetCharacterMountCollection) []int {
	var result []int
...
func getFilteredMounts(character battlenetEntities.BattleNetCharacter, mounts []*documents.MountDocument, collectedIds []int) map[int]*documents.MountDocument {
